...
In Bagcoin, each account is separated into
...
In Bagcoin an *authority* consists of one or many entities that authorize an
...
must sign in order for the transaction to be valid. Now, in Bagcoin, we have
