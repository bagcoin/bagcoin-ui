...
BGC'le temasınızı arttırmak ve USD,EUR,GOLD gibi BitAktiflere likidite sağlamak için 
bu BitAktifleri ağdan *ödünç* alabilir ve *kısa satabilirsiniz*. Prosedürü burada kısaca 
anlatacağız.

## Ödünç Alma

Bagcoin ağının herhangi bir miktarda BitVarlığı piyasaya sürmesi ve yeterli teminat 
karşılığında katılımcılara borç vermesi mümkündür. 

 * *uzlaşma fiyatı* : 1 BGC in dış borsalarda alıp-satılırkenki fiyatı.
...
Bagcoin ağı , ödünç aldığı bitVarlığın karşılığında yeterince teminatı bulunmayan 
...
fiyatından(x/BGC) daha düşük olduğu anda teminatı zorla sattırılır.
...
piyasa fiyatından satın alır ve pozisyonu kapar. Teminattan geri kalan BGC müşteriye 
iade edilir.
...
teminat oranı arttırılırsa , ilave miktarda BGC teminat olarak kilit altına alınır, teminat 
oranının düşürülmesi ise tekabül eden miktarda BitVarlığın ağa geri ödenmesini 
gerektirir.

## Kapamak

Ödünç/kısa pozisyonunu kapamak için , ilk önce kişinin , Bagcoin ağına teslim 
